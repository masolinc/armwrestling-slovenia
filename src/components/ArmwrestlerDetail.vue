<!-- PersonDetail.vue -->
<template>
  <div v-if="person" class="min-h-screen flex">
    <!-- Inner wrapper vertically centered -->
      ...
      >
        ...
        <div class="flex-1 min-w-0 w-full lg:self-center">
          ...
          <ul class="space-y-3 text-base leading-relaxed text-neutral-800">
            ...
            <li v-if="person.city"><span class="font-semibold">Kraj:</span> {{ person.city }}</li>
            ...
            <li v-if="person.contact?.phone">
              ...
              <a class="underline hover:text-neutral-700" :href="`tel:${person.contact.phone}`">
